...
$(document).ready(function () {
    ...
    $("#btn-unsubscribe").click(function () {
        ...
        var num = $("#numberInputForm").val();
        var unsubscribeEndpoint = 'http://104.236.3.239:8000/api/unsubscribe/number/' + num;
        console.log("calling " + unsubscribeEndpoint);
        $.ajax({
            url: unsubscribeEndpoint,
            type: 'POST',
            success: function (response) {
                alert("You are unsubscribed from ThunderBuddy.");
            },
            error: function (request, status, error) {
                alert("An error occured with our servers, please try again later");
    ...
    $("#btn-subscribe").click(function () {
        ...
        event.preventDefault();
        var num = $("#numberInputForm").val();
        var zip = $("#zipInputForm").val();
        var subscribeEndpoint = 'http://104.236.3.239:8000/api/subscribe/number/' + num + "/zip/" + zip;
        console.log("calling " + subscribeEndpoint);
        $.ajax({
            url: subscribeEndpoint,
            type: 'POST',
            success: function (response) {
                alert("You are subscribed to ThunderBuddy!");
            },
            error: function (request, status, error) {
                alert("An error occured with our servers, please try again later");
                console.log("request - " + request.toString());
